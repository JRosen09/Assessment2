...
/* 
    ...
    write a new function (`canWeDeliverTwo`)
    below, using the `includes` array method. 
    Look it up on MDN (don't know this abreviation!!!!!) if you're not sure how to use 
    it. 
...
/*
    ...
    Reassign the value of the first deal's title to be itself, 
